...
var TransactionController = function () {
    ...
    var TransactionController = _classThis = /** @class */ (function () {
        function TransactionController_1(transactionService) {
            this.transactionService = (__runInitializers(this, _instanceExtraInitializers), transactionService);
        }
        TransactionController_1.prototype.deposit = function (user, depositDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.transactionService.deposit(user.id, depositDto)];
                });
            });
        };
        TransactionController_1.prototype.withdraw = function (user, withdrawDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.transactionService.withdraw(user.id, withdrawDto)];
                });
            });
        };
        TransactionController_1.prototype.transfer = function (user, transferDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.transactionService.transfer(user.id, transferDto)];
                });
            });
        };
        TransactionController_1.prototype.findAll = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                var isAdmin;
                return __generator(this, function (_a) {
                    isAdmin = user.role === 'admin';
                    return [2 /*return*/, this.transactionService.findAll(user.id, isAdmin)];
                });
            });
        };
        TransactionController_1.prototype.findOne = function (id, user) {
            return __awaiter(this, void 0, void 0, function () {
                var isAdmin;
                return __generator(this, function (_a) {
                    isAdmin = user.role === 'admin';
                    return [2 /*return*/, this.transactionService.findOne(id, user.id, isAdmin)];
                });
            });
        };
    ...
    (function () {
        ...
        _deposit_decorators = [(0, common_1.Post)('deposit')];
        _withdraw_decorators = [(0, common_1.Post)('withdraw')];
