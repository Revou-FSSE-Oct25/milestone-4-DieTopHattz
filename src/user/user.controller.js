...
var UserController = function () {
    var _classDecorators = [(0, common_1.Controller)('user'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var UserController = _classThis = /** @class */ (function () {
        ...
        UserController_1.prototype.updateProfile = function (user, updateUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.update(user.id, updateUserDto)];
                });
            });
        };
