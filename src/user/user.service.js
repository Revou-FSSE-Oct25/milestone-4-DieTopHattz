...
var UserService = function () {
    ...
    var UserService = _classThis = /** @class */ (function () {
        ...
        UserService_1.prototype.create = function (userData) {
            return __awaiter(this, void 0, void 0, function () {
                var existingUser, hashedPassword, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.findByEmail(userData.email)];
                        case 1:
        ...
        UserService_1.prototype.update = function (id, updateData) {
            return __awaiter(this, void 0, void 0, function () {
                var user, _a;
