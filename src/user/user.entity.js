...
var User = function () {
    ...
    (function () {
        ...
        _role_decorators = [(0, typeorm_1.Column)({ type: 'enum', enum: ['user', 'admin',], default: 'user' })];
        _createdAt_decorators = [(0, typeorm_1.CreateDateColumn)()];
        _updatedAt_decorators = [(0, typeorm_1.UpdateDateColumn)()];
        _accounts_decorators = [(0, typeorm_1.OneToMany)(function () { return account_entity_1.Account; }, function (account) { return account.user; })];
        _transactions_decorators = [(0, typeorm_1.OneToMany)(function () { return transaction_entity_1.Transaction; }, function (transaction) { return transaction.user; })];
