...
var CreateAccountDto = function () {
    ...
    var _initialBalance_decorators;
    var _initialBalance_initializers = [];
    var _initialBalance_extraInitializers = [];
    ...
    return _a = /** @class */ (function () {
            function CreateAccountDto() {
                ...
                this.initialBalance = (__runInitializers(this, _bankName_extraInitializers), __runInitializers(this, _initialBalance_initializers, void 0));
                this.currency = (__runInitializers(this, _initialBalance_extraInitializers), __runInitializers(this, _currency_initializers, void 0));
        ...
        (function () {
            ...
            _accountName_decorators = [(0, class_validator_1.IsString)()];
            _bankName_decorators = [(0, class_validator_1.IsString)()];
            _initialBalance_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsNumber)(), (0, class_validator_1.Min)(0)];
            _currency_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.IsIn)(['IDR', 'USD', 'EUR'])];
            ...
            __esDecorate(null, null, _initialBalance_decorators, { kind: "field", name: "initialBalance", static: false, private: false, access: { has: function (obj) { return "initialBalance" in obj; }, get: function (obj) { return obj.initialBalance; }, set: function (obj, value) { obj.initialBalance = value; } }, metadata: _metadata }, _initialBalance_initializers, _initialBalance_extraInitializers);
